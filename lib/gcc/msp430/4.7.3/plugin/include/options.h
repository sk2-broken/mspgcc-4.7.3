...
enum opt_code
{
  ...
  OPT_mc16 = 988,                            /* -mc16 */
  OPT_mc20 = 989,                            /* -mc20 */
  OPT_mcode_region_ = 990,                   /* -mcode-region= */
  OPT_mcpu_ = 991,                           /* -mcpu= */
  OPT_md16 = 992,                            /* -md16 */
  OPT_md20 = 993,                            /* -md20 */
  OPT_mdata_region_ = 994,                   /* -mdata-region= */
  OPT_mdisable_watchdog = 995,               /* -mdisable-watchdog */
  OPT_menable_libcall_shift = 996,           /* -menable-libcall-shift */
  OPT_misr20 = 997,                          /* -misr20 */
  OPT_mivcnt_ = 998,                         /* -mivcnt= */
  OPT_mmcu_ = 999,                           /* -mmcu= */
  OPT_mmemory_model_ = 1000,                 /* -mmemory-model= */
  OPT_mmpy_ = 1001,                          /* -mmpy= */
  OPT_mnoint_hwmul = 1002,                   /* -mnoint-hwmul */
  OPT_msr16 = 1003,                          /* -msr16 */
  OPT_msr20 = 1004,                          /* -msr20 */
  OPT_n = 1005,                              /* -n */
  OPT_no_canonical_prefixes = 1006,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1007,              /* -no-integrated-cpp */
  OPT_nocpp = 1008,                          /* -nocpp */
  OPT_nodefaultlibs = 1009,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1010,                   /* -nostartfiles */
  OPT_nostdinc = 1011,                       /* -nostdinc */
  OPT_nostdinc__ = 1012,                     /* -nostdinc++ */
  OPT_nostdlib = 1013,                       /* -nostdlib */
  OPT_o = 1014,                              /* -o */
  OPT_p = 1015,                              /* -p */
  OPT_pass_exit_codes = 1016,                /* -pass-exit-codes */
  OPT_pedantic = 1017,                       /* -pedantic */
  OPT_pedantic_errors = 1018,                /* -pedantic-errors */
  OPT_pg = 1019,                             /* -pg */
  OPT_pie = 1020,                            /* -pie */
  OPT_pipe = 1021,                           /* -pipe */
  OPT_print_file_name_ = 1022,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1023,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1024,          /* -print-multi-directory */
  OPT_print_multi_lib = 1025,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1026,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1027,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1028,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1029,               /* -print-prog-name= */
  OPT_print_search_dirs = 1030,              /* -print-search-dirs */
  OPT_print_sysroot = 1031,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1032,   /* -print-sysroot-headers-suffix */
  ...
  OPT_time = 1083,                           /* -time */
  OPT_time_ = 1084,                          /* -time= */
  OPT_traditional = 1085,                    /* -traditional */
  OPT_traditional_cpp = 1086,                /* -traditional-cpp */
  OPT_trigraphs = 1087,                      /* -trigraphs */
  OPT_u = 1088,                              /* -u */
  OPT_undef = 1089,                          /* -undef */
  OPT_v = 1090,                              /* -v */
  OPT_version = 1091,                        /* -version */
  OPT_w = 1092,                              /* -w */
  OPT_wrapper = 1093,                        /* -wrapper */
  OPT_x = 1094,                              /* -x */
  OPT_z = 1095,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
